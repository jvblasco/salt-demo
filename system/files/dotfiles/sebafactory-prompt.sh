...
# Set environment variables for color terminals
...
if tput setaf 1 &> /dev/null; then
  ...
  # COLOR REFERENCE #
  ###################
  # sexy_bash_prompt_user_color="$sexy_bash_prompt_bold$(tput setaf 184)" # BOLD BRIGHT YELLOW
  # sexy_bash_prompt_user_color="$sexy_bash_prompt_bold$(tput setaf 127)" # BOLD DARK PURPLE
  # sexy_bash_prompt_user_color="$sexy_bash_prompt_bold$(tput setaf 128)" # BOLD DARK PURPLE-WHITE
  # sexy_bash_prompt_user_color="$sexy_bash_prompt_bold$(tput setaf 148)" # BOLD YELLOW-GREEN
  # sexy_bash_prompt_user_color="$sexy_bash_prompt_bold$(tput setaf 202)" # BOLD ORANGE
  # sexy_bash_prompt_user_color="$sexy_bash_prompt_bold$(tput setaf 201)" # BOLD BRIGHT PURPLE
  # sexy_bash_prompt_user_color="$sexy_bash_prompt_bold$(tput setaf 34)" # BOLD BRIGHT GREEN
  # sexy_bash_prompt_git_status_color="$sexy_bash_prompt_bold$(tput setaf 141)" # BOLD LIGHT PURPLE
  # Original colors:
  ...
  # Add conditional to make root user symbol prompt bright red as a reminder
  if [[ "$UID" == 0 ]]; then
    sexy_bash_prompt_bold="$(tput setaf 1)"
  else
    sexy_bash_prompt_bold="$(tput setaf 255)"
  fi
  sexy_bash_prompt_reset="$(tput sgr0)"

  # If the terminal supports at least 256 colors, write out our 256 color based set
  if [[ "$(tput colors)" -ge 256 ]] &> /dev/null; then
    # Add conditional to make root user color bright red as a reminder
    if [[ "$UID" == 0 ]]; then
      sexy_bash_prompt_user_color="$sexy_bash_prompt_bold$(tput setaf 1)" # BOLD RED
    else
      sexy_bash_prompt_user_color="$sexy_bash_prompt_bold$(tput setaf 178)" # BOLD DARK YELLOW
    fi
    # Customized colors:
    sexy_bash_prompt_preposition_color="$sexy_bash_prompt_bold$(tput setaf 244)" # BOLD WHITE
    sexy_bash_prompt_device_color="$sexy_bash_prompt_bold$(tput setaf 39)" # BOLD ORANGE
    sexy_bash_prompt_dir_color="$sexy_bash_prompt_bold$(tput setaf 76)" # BOLD GREEN
    sexy_bash_prompt_git_status_color="$sexy_bash_prompt_bold$(tput setaf 127)" # BOLD DARK PURPLE
    sexy_bash_prompt_git_progress_color="$sexy_bash_prompt_bold$(tput setaf 9)" # BOLD RED
  else
...
HOSTNAME=$(python -c "from socket import gethostname; print('.'.join(gethostname().split('.')[:2]))")
...
\[$sexy_bash_prompt_device_color\]\$HOSTNAME\[$sexy_bash_prompt_reset\] \
